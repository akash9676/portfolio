                ...
                <ol class="relative border-l border-dashed border-white max-w-sm md:max-w-2xl lg:max-w-4xl ">           
                    {
                        experiences && experiences.map((experience) => {
                            return (
                                <motion.li class="mb-10 ml-8" key={experience.id}>            
                                    ...
                                    >
                                        <h3 class="flex items-center mb-1 pb-1 text-2xl md:text-4xl font-semibold text-intro">{experience.job}</h3>
                                        <time class="block mb-2 text-sm md:text-base font-normal leading-none text-white">{experience.job_date}</time>
                                        <p class="mb-4 text-base md:text-lg font-opensans text-white">
                    ...
                    {/* <motion.li class="mb-10 ml-8">            
                        ...
                        animate = {{ type : "easeinout" }}
                        >
                            <h3 class="flex items-center mb-1 pb-1 text-2xl md:text-4xl font-semibold text-intro">Google Developer Student Clubs</h3>
                            <time class="block mb-2 text-sm md:text-base font-normal leading-none text-white">September, 2022</time>
                            <p class="mb-4 text-base md:text-lg font-opensans text-white">
